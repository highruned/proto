...
import D3.Hireling_pb2
import D3.Items_pb2
import D3.OnlineService_pb2

_VISUALEQUIPMENT.fields_by_name['visual_item'].message_type = _VISUALITEM
_DIGEST.fields_by_name['hero_id'].message_type = D3.OnlineService_pb2._ENTITYID
...
_SAVEDDATA.fields_by_name['hireling_saved_data'].message_type = D3.Hireling_pb2._SAVEDDATA
...
_SAVEDDEFINITION.fields_by_name['items'].message_type = D3.Items_pb2._ITEMLIST
_SAVEDDEFINITION.fields_by_name['quest_reward_history'].message_type = _QUESTREWARDHISTORYENTRY
_ESCROW.fields_by_name['generator'].message_type = D3.Items_pb2._GENERATOR
